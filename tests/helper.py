...
@pytest.fixture(params=[
    ...
    GELFTcpHandler("127.0.0.1", TEST_TCP_PORT, extra_fields=True),
    GELFTcpHandler("127.0.0.1", TEST_TCP_PORT, extra_fields=True, debugging_fields=True),
    GELFTcpHandler("localhost", TEST_TLS_PORT),
    GELFTcpHandler("localhost", TEST_TLS_PORT, tls_server_name="localhost", tls=True, tls_capath=TEST_CERT),
    GELFTcpHandler("127.0.0.1", TEST_TLS_PORT),
    GELFTcpHandler("127.0.0.1", TEST_TLS_PORT, tls_server_name="localhost", tls=True, tls_capath=TEST_CERT),
