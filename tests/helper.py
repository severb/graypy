...
@pytest.fixture(params=[
    ...
    GELFTcpHandler("localhost", TEST_TLS_PORT, tls=True,  tls_server_name="localhost", tls_capath=TEST_CERT),
    GELFTcpHandler("127.0.0.1", TEST_TLS_PORT, tls=True, tls_server_name="localhost", tls_capath=TEST_CERT),
