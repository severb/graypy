...
import logging
import pytest
from graypy import GELFTLSHandler, GELFTCPHandler, GELFUDPHandler, \
    GELFHTTPHandler
...
@pytest.fixture(params=[
    ...
    GELFTLSHandler('127.0.0.1', TEST_TLS_PORT, validate=True, ca_certs=TEST_CERT, extra_fields=True),
])
def handler(request):
